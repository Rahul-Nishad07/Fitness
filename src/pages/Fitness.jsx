      ...
      <div className="row">
        <div className="col-md-8">
          <div className="single-popular-post">
            ...
            <p>Fitness encompasses overall health and well-being achieved through regular physical activity, proper nutrition, and mental wellness practices. It includes strength, endurance, flexibility, and cardiovascular health.</p>
            <div className="description-box">
              <h3 className="sub-title">Description</h3>
              <p>Fitness is a lifestyle prioritizing physical activity, nutrition, and mental wellness. It involves regular exercise, balanced diet, and mindfulness practices to optimize health and well-being.</p>
            </div>
            <div className="work-benifits">
              <h3 className="sub-title">Workout benefits</h3>
              <ul>
                <li><i className="fa fa-angle-right" /> Physical Health: Fitness improves cardiovascular health, strength, flexibility, and overall body function.</li>
                <li><i className="fa fa-angle-right" /> Mental Well-being: Reduces stress, anxiety, and depression while enhancing mood and cognition.
                </li>
                <li><i className="fa fa-angle-right" /> Longevity: Regular exercise decreases the risk of chronic diseases, promoting longevity.</li>
                <li><i className="fa fa-angle-right" /> Quality of Life: Fitness enhances energy levels, sleep quality, and self-esteem.</li>
              </ul>
            </div>
          </div>
