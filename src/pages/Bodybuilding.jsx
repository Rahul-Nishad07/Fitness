        ...
        <div className="col-md-8">
          <div className="single-popular-post">
            <div className="img-box">
              <img src="public/img/popular-class-page/bodybuilding.jpg" alt="Awesome Image" />
            ...
            <div className="description-box">
              ...
              <p>Bodybuilding is a discipline combining resistance training, nutrition, and dedication to sculpting and defining muscles. It emphasizes strength, size, and symmetry, often for aesthetic purposes or competitive bodybuilding events. Achieving success requires meticulous training, strategic nutrition, and unwavering commitment to a demanding lifestyle centered around physical development.</p>
            </div>
            <div className="work-benifits">
              ...
              <ul>
                ...
                <li><i className="fa fa-angle-right" /> Mental well-being improves with stress reduction and increased confidence.</li>
